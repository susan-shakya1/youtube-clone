      ...
      <div className="w-full h-full flex flex-col gap-3  py-2 overflow-y-auto">
        ...
        <div className="flex flex-col mx-3 gap-3">
          <div className="flex flex-col mx-3 gap-1">
            ...
            <span className="text-xs text-[#aaaaaa]">contact us Creators</span>
            <span className="text-xs text-[#aaaaaa]">Advertise Developers</span>
          </div>
          <div className="flex flex-col mx-3 gap-1">
            <span className="text-xs text-[#aaaaaa]">
              About Press Copyright
          ...
          <h1 className="text-sm text-[#aaaaaa] pl-2 ">@ 2024 Google LLC</h1>
        </div>
      </div>
    </div>
  );
